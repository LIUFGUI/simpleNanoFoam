...
Visc_Bulk=1e-6
Visc_walls=0.55e-6
Visc_fixedWalls_org=3.25e-6
Visc_fixedWalls_inorg=0.55e-6
Visc_fixedWalls_clay=0.55e-6

## Define the thickness of near-wall region (m)
Dist_walls=0.7e-9
Dist_fixedWalls_org=0.7e-9
Dist_fixedWalls_inorg=0.7e-9
Dist_fixedWalls_clay=0.7e-9

## Define slip length
Ls_walls=22.8423e-9
Ls_fixedWalls_org=0.1025e-9
Ls_fixedWalls_inorg=22.8423e-9
Ls_fixedWalls_clay=22.8423e-9
...
sed -i "s/Visc_fixedWalls_clay/$Visc_fixedWalls_clay/g" constant/transportProperties
...
sed -i "s/Dist_fixedWalls_clay/$Dist_fixedWalls_clay/g" constant/transportProperties
...
sed -i "s/Ls_fixedWalls_clay/$Ls_fixedWalls_clay/g" 0/U
#sed -i "s/Ux/$Ux/g" 0/U
#sed -i "s/Uy/$Uy/g" 0/U
#sed -i "s/Uz/$Uz/g" 0/U
